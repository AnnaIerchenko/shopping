...
const Product = ({item}) => {
  ...
  const  iconStyle = 'h-[40px] w-[40px] rounded-full bg-white flex items-center justify-center m-3 cursor-pointer hover:bg-[#894af3] hover:text-white hover:scale-[1.2] ease-in duration-100 cursor-pointer'
